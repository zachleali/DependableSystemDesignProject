...
@.str11 = private unnamed_addr constant [17 x i8] c"Call Count = %d\0A\00", align 1
...
define void @callCount() #0 {
  ...
  %4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str11, i32 0, i32 0), i32 %3)
  ret void
}
